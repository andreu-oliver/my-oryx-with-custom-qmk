...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_HASH,        KC_DLR,         KC_LPRN,        KC_RPRN,        KC_GRAVE,       KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_4,           KC_5,           KC_6,           KC_KP_PLUS,     ES_MINS,        
  ...
  [2] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, ES_LBRC,        KC_UP,          ES_RBRC,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
...
void dance_2_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[2].step) {
        case SINGLE_TAP: register_code16(ES_MINS); break;
        case SINGLE_HOLD: register_code16(KC_UNDS); break;
        case DOUBLE_TAP: register_code16(ES_MINS); register_code16(ES_MINS); break;
        case DOUBLE_SINGLE_TAP: tap_code16(ES_MINS); register_code16(ES_MINS);
    }
}
...
void dance_2_reset(tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[2].step) {
        case SINGLE_TAP: unregister_code16(ES_MINS); break;
        case SINGLE_HOLD: unregister_code16(KC_UNDS); break;
        case DOUBLE_TAP: unregister_code16(ES_MINS); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(ES_MINS); break;
    }
...
void dance_4_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[4].step) {
        ...
        case SINGLE_HOLD: register_code16(ES_BSLS_MAC); break;
...
void dance_4_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[4].step) {
        ...
        case SINGLE_HOLD: unregister_code16(ES_BSLS_MAC); break;
...
void dance_5_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[5].step) {
        ...
        case SINGLE_HOLD: register_code16(ES_IQUE); break;
...
void dance_5_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[5].step) {
        ...
        case SINGLE_HOLD: unregister_code16(ES_IQUE); break;
...
void dance_7_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[7].step) {
        ...
        case SINGLE_HOLD: register_code16(ES_LBRC); break;
...
void dance_7_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[7].step) {
        ...
        case SINGLE_HOLD: unregister_code16(ES_LBRC); break;
...
void dance_8_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[8].step) {
        case SINGLE_TAP: register_code16(ES_CCED); break;
        case SINGLE_HOLD: register_code16(ES_RBRC); break;
        case DOUBLE_TAP: register_code16(ES_CCED); register_code16(ES_CCED); break;
        case DOUBLE_SINGLE_TAP: tap_code16(ES_CCED); register_code16(ES_CCED);
    }
}
...
void dance_8_reset(tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[8].step) {
        case SINGLE_TAP: unregister_code16(ES_CCED); break;
        case SINGLE_HOLD: unregister_code16(ES_RBRC); break;
        case DOUBLE_TAP: unregister_code16(ES_CCED); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(ES_CCED); break;
    }
...
void dance_9_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[9].step) {
        case SINGLE_TAP: register_code16(ES_HASH); break;
        case SINGLE_HOLD: register_code16(ES_AMPR); break;
        case DOUBLE_TAP: register_code16(ES_HASH); register_code16(ES_HASH); break;
        case DOUBLE_SINGLE_TAP: tap_code16(ES_HASH); register_code16(ES_HASH);
    }
}
...
void dance_9_reset(tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[9].step) {
        case SINGLE_TAP: unregister_code16(ES_HASH); break;
        case SINGLE_HOLD: unregister_code16(ES_AMPR); break;
        case DOUBLE_TAP: unregister_code16(ES_HASH); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(ES_HASH); break;
    }
...
void dance_10_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[10].step) {
        ...
        case SINGLE_HOLD: register_code16(ES_PIPE); break;
...
void dance_10_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[10].step) {
        ...
        case SINGLE_HOLD: unregister_code16(ES_PIPE); break;
...
void dance_11_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[11].step) {
        ...
        case SINGLE_HOLD: register_code16(ES_TILD); break;
...
void dance_11_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[11].step) {
        ...
        case SINGLE_HOLD: unregister_code16(ES_TILD); break;
...
void dance_14_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[14].step) {
        ...
        case SINGLE_HOLD: register_code16(ES_APOS); break;
        case DOUBLE_TAP: register_code16(ES_NTIL); register_code16(ES_NTIL); break;
...
void dance_14_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[14].step) {
        ...
        case SINGLE_HOLD: unregister_code16(ES_APOS); break;
...
void dance_15_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[15].step) {
        ...
        case SINGLE_HOLD: register_code16(ES_GRV); break;
        case DOUBLE_TAP: register_code16(ES_ACUT); register_code16(ES_ACUT); break;
...
void dance_15_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[15].step) {
        ...
        case SINGLE_HOLD: unregister_code16(ES_GRV); break;
        case DOUBLE_TAP: unregister_code16(ES_ACUT); break;
...
void dance_16_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[16].step) {
        ...
        case SINGLE_HOLD: register_code16(ES_LCBR); break;
...
void dance_16_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[16].step) {
        ...
        case SINGLE_HOLD: unregister_code16(ES_LCBR); break;
...
void dance_17_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[17].step) {
        ...
        case SINGLE_HOLD: register_code16(ES_RCBR); break;
...
void dance_17_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[17].step) {
        ...
        case SINGLE_HOLD: unregister_code16(ES_RCBR); break;
...
void dance_19_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[19].step) {
        ...
        case SINGLE_HOLD: register_code16(ES_COLN); break;
...
void dance_19_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[19].step) {
        ...
        case SINGLE_HOLD: unregister_code16(ES_COLN); break;
